...
class TreinamentosDoNen extends StatefulWidget{
  ...
  const TreinamentosDoNen({Key? key, required this.controller}) : super(key: key);
...
class _TreinamentosDoNenState extends State<TreinamentosDoNen>{
  ...
  Future<void> _initializeData() async {
    await _controller.getNenContent(titulo: "Tipos de treinamento do Nen");
    setState(() {});
  }
            ...
            children: [
              ...
              ...widget.controller.nenContent!.map((conteudo){
                ...
                Widget subTitle(int number){
                  return Text(conteudo.titulos[number], style: TextStyle(color: Colors.white, fontSize: fontSubTitleSize, fontFamily: 'SM'),);
                  }
                        ...
                        children: [
                          ...
                          CarouselSlider(
                            options: CarouselOptions(
                              height: isHorizontal ? constraints.maxHeight : constraints.maxHeight * .3,
                              initialPage: 0,
