...
class TecnicasAvancadasNen extends StatefulWidget {
  ...
  const TecnicasAvancadasNen({Key? key, required this.controller})
      : super(key: key);
...
class _TecnicasAvancadasNenState extends State<TecnicasAvancadasNen> {
  ...
  Future<void> _initializeData() async {
    await widget.controller.getNenContent(titulo: "Técnicas avançadas do Nen");
    setState(() {});
  }
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    image: DecorationImage(
                                      image:
                                          ExactAssetImage(conteudo.images[i]),
                                    ),
                                  ),
                                ),
