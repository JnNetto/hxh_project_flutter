...
class SubcategoriasDoNen extends StatefulWidget{
  ...
  const SubcategoriasDoNen({Key? key, required this.controller}) : super(key: key);
...
class _SubcategoriasDoNenState extends State<SubcategoriasDoNen>{
  ...
  Future<void> _initializeData() async {
    await _controller.getNenContent(titulo: "Subcategorias do Nen");
    setState(() {});
  }
                  ...
                  child: Center(
                    child: FractionallySizedBox(
                      ...
                      child: Column(
                        children: [
                          const SizedBox(height: 30,),
                          Text(conteudo.content[0], style: TextStyle(color: Colors.white, fontSize: fontTextSize, fontFamily: 'SM'),),
                          const SizedBox(height: 30),
                          ...contentRepeated,
                          const SizedBox(height: 30,)
                        ],
