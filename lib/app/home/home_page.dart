...
class _HomePage extends State<HomePage> with WidgetsBindingObserver {
  ...
  var _isVisible = true;
  void _showMenu(
      BuildContext contextDialog, double maxHeight, double maxWidth) {
    showDialog(
      context: contextDialog,
      builder: (BuildContext contextDialog) {
        return OrientationBuilder(
          builder: (context, orientation) {
            double contentWidth = orientation == Orientation.landscape
                ? maxWidth * 0.2
                : maxWidth * 0.5;
            double contentHeight = orientation == Orientation.landscape
                ? maxHeight * 0.9
                : maxHeight * 0.5;
            double fontSizeButtom = orientation == Orientation.landscape
                ? maxWidth * 0.013
                : maxWidth * 0.03;
                        ...
                        Positioned(
                          ...
                          child: Center(
                            child: Text(
                              'Bem Vindo!',
                              style: TextStyle(
                                  fontSize: fontSize, fontFamily: "SF"),
                            ),
                          ),
                        ),
                        Positioned(
